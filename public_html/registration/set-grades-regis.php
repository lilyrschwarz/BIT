...
<body>
  <ul>
             <li><a class="active" href="edit-grades-regis.php">Back</a></li>
  ...
  <hr>
    <?php
       ...
       $username = "SJL";
        ...
        where T.uid='".$_POST["studuid"]."' AND T.crn=C.crn AND T.uid=U.uid AND U.active='yes';";
        ...
        if(mysqli_num_rows($result)>0){
            ...
            while($row = mysqli_fetch_assoc($result)){
              echo '<form action="set-grades-regis.php" method="post">';
          ...
          if($_POST["grade"]=='A' || $_POST["grade"]=='A-' || $_POST["grade"]=='B+' || $_POST["grade"]=='B' || $_POST["grade"]=='B-' || $_POST["grade"]=='C+' || $_POST["grade"]=='C' || $_POST["grade"]=='F') {
            ...
            header("Location: edit-grades-regis.php");
          } else {
