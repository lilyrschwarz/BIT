...
<html lang="en">
    ...
    <body>
        <ul>
         ...
         <form action="viewAllStudentsM.php" method="post">
            Enter user program type: <input type="text" name="ptype">
        ...
        <?php
            ...
            //A specific UID was searched
                ...
                $query = "select fname, lname, uid, email, type, active from user where type='".$_POST["ptype"]."' order by lname";
            $result = mysqli_query($connection, $query);
            if (mysqli_num_rows($result) > 0) {
                echo "<table>";
                //Display a table of all the students
                ...
                echo "</table>";
                    ...
                    echo "No student with that program type!";
                }
            }
