...
<html lang="en">
	...
	<body>
        <ul>
         ...
         <form action="viewAllStudentsU.php" method="post">
        ...
        <?php
            ...
            //A specific UID was searched
                ...
                $query = "select fname, lname, uid, email, type, active from user where uid=".$_POST["uid"]." and (type = 'MS' or type = 'PHD') order by lname";
            $result = mysqli_query($connection, $query);
            if (mysqli_num_rows($result) > 0) {
                echo "<table>";
                //Display a table of all the students
