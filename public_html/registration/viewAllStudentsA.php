...
<html lang="en">
    ...
    <body>
        <ul>
             <li><a class="active" href="searchStudentsBy.php">Back</a></li>
             <li style="float:right"><a href="logout.php">Log Out</a></li>
        </ul>
         <form action="viewAllStudentsA.php" method="post">
            Enter user active type: <input type="text" name="active">
        ...
        <?php
            ...
            //A specific UID was searched
                ...
                $query = "select fname, lname, uid, email, type, active from user where active='".$_POST["active"]."' and (type = 'MS' or type = 'PHD') order by lname";
            $result = mysqli_query($connection, $query);
            if (mysqli_num_rows($result) > 0) {
                echo "<table>";
                //Display a table of all the students
                ...
                echo "</table>";
                    ...
                    echo "No student with that active type!";
                }
            }
