...
<body>
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" class="source-sans">
        ...
        Room ID: <input type="number" name="location" value="<?php echo $location;?>">
                <span class="error">
            <?php echo "*".$locationErr;?></span>

        <br><br>

        Prereq 1 (optional): <input type="text" name="prereq1" value="<?php echo $prereq1;?>">
                <span class="error">
            <?php echo "*".$prereq1Err;?></span>

        <br><br>

        Prereq 2 (optional): <input type="text" name="prereq2" value="<?php echo $prereq2;?>">
                <span class="error">
            <?php echo "*".$prereq2Err;?></span>
